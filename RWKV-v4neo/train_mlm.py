...
if __name__ == "__main__":
    ...
    parser.add_argument("--wandb", default="rwkv-512", type=str)  # wandb project name. if "" then don't use wandb
...
"""
    ...
    pad_id = 1
    mask_token_id = 3
    wikipedia_dir = "/home/yueyulin/projs/wikipedia_512"

    from src.trainer import train_callback, generate_init_weight
    import datasets
    train_data = datasets.load_from_disk(wikipedia_dir)
    from src.mnbvc_datasets import MyDataset
