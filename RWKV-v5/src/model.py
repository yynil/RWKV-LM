...
if torch.cuda.is_available():
    ...
    wkv5_mps = torch.utils.cpp_extension.load(
        name='RWKV5Ops',
        sources=[os.path.join(mps_dir,'RWKV5Ops.mm')],
    ...
    if torch.backends.mps.is_available():
        ...
        def forward(ctx, B, T, C, H, r, k, v, w, u):
            with torch.no_grad():
                ...
                wkv5_mps.wkv5_forward(B, T, C, H, r, k, v, eew, u, y)
                return y
    ...
    def configure_optimizers(self):
        ...
        if args.weight_decay > 0:
            ...
            if torch.backends.mps.is_available():
                ...
                return FusedAdam(optim_groups, lr=self.args.lr_init, betas=self.args.betas, eps=self.args.adam_eps, adam_w_mode=False, weight_decay=0, amsgrad=False)
