...
torch::Tensor& dispatchRwkv5Forward(
    ...
    @autoreleasepool {
        ...
        dispatch_sync(serialQueue, ^(){
            ...
            [computeEncoder setBuffer:getMTLBufferStorage(state) offset:state.storage_offset() * state.element_size() atIndex:4];
            [computeEncoder setBuffer:getMTLBufferStorage(r) offset:r.storage_offset() * r.element_size() atIndex:5];
            [computeEncoder setBuffer:getMTLBufferStorage(k) offset:k.storage_offset() * k.element_size() atIndex:6];
            [computeEncoder setBuffer:getMTLBufferStorage(v) offset:v.storage_offset() * v.element_size() atIndex:7];
            [computeEncoder setBuffer:getMTLBufferStorage(w) offset:w.storage_offset() * w.element_size() atIndex:8];
            [computeEncoder setBuffer:getMTLBufferStorage(u) offset:u.storage_offset() * u.element_size() atIndex:9];
            [computeEncoder setBuffer:getMTLBufferStorage(y) offset:y.storage_offset() * y.element_size() atIndex:10];
